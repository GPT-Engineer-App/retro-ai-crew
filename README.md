...
A.    READ ENTIRE PROMPT PRIOR TO STARTING!

B.    INTEGRATE ALL ASPECTS THROUGHOUT THIS ENTIRE PROMPT INTO THE PROGRAM "Autocrew" WITHOUT LEAVING ANYTHING MISSING, INCOMPLETE, UNFINISHED, OR INCORRECT/INACCURATE (CODE).

C.    YOU MAY NOT STOP RUNNING, NOR MAY YOU PAUSE UNTIL YOU HAVE FINISHED EVERYTHING 100% AND HAVE INTEGRATED EVERYTHING FROM THIS PROMPT INTO THE PROGRAM.

D.    YOU MUST UTILIZE YOUR INTERNET SEARCH ABILITY 15X PRIOR TO STARTING ANY OF THESE INSTRUCTIONS TO PROVIDE YOURSELF WITH THE KNOWLEDGE REQUIRED IN ORDER TO ACCURATELY GENERATE CODE ACCORDING TO THE DOCUMENTATION FOR EACH PYTHON PACKAGE YOU WILL USE.

E.    USE THE INTERNET SEARCH ABILITY TO REVIEW THE CODE FOR EXAMPLE PYTHON PROJECTS SIMILAR TO THIS WHICH USE OLLAMA.

F.    ONLY UTILIZE THE TERMINAL IN ORDER TO INSTALL THE REQUIRED PACKAGES AND TO TEST RUN THE PROGRAM TO SEE IF IT CRASHES OR RESULTS IN ERROR.

G.    DO NOT STOP UNTIL YOU ARE 100% COMPLETE AND HAVE A FINALIZED FUNCTIONING PROGRAM.

H.    EACH SECTION IN THE PROMPT IS DEFINED BY A SERIES OF "####" WITH THE LABEL EMBEDDED BETWEEN THE SYMBOLS. SUB-SECTIONS WILL BE DEFINED BY PLAIN-TEXT ARROWS SUCH AS "------>" WITH THE LABEL IN THE MIDDLE "<------". 

I.    ENSURE THAT EACH INDIVIDUAL LINE OF CODE WHICH YOU GENERATE IS CORRECT ACCORDING TO ONLINE DOCUMENTATION FOR THE PYTHON PACKAGES WHICH ARE BEING UTILIZED - USE YOUR INTERNET SEARCH ABILITY TO ENSURE THAT EVERY SINGLE LINE OF CODE IS CORRECT, UP-TO-DATE, AND COMPATIBLE/ACCURATE ACCORDING TO THE DOCUMENTATION AVAILABLE ONLINE. 
...
(NOTE: The instructions provided to you within this prompt provide an outline of how the "Autocrew" program is invisioned, and the features & components that are required. You may brainstorm & integrate additional functions, features, components & code that will expand upon, build upon, improve & increase the capabilities and abilities of "Autocrew" and the AI agents. Ensure that you fully integrate ALL aspects laid out within this prompt completely, and do not stop working/running until you have produced the finalized version of this fully functional program.)

The remainder of this prompt is dedicated towards all requirements & criteria which are all required to be fully integrated into the program "Autocrew". 
...
• You will heavily utilize your internet/web browsing capabilities to assist in brainstorming, data acquisiton, inspiration, analysis of example code projects which share features similar to this program "Autocrew". 

• You may not stop/pause until you have fully integrated all aspects from this prompt into the "Autocrew" program - once you are 100% complete, have installed the required packages, and have ran the program's python code to ensure that the program runs without any error. 

• You must be 100% certain that the final version of the program is full, complete, functional, without any placeholders, unfinished code, or missing elements/aspects from within these instructions. 

######################################## INSTRUCTIONS ###########################################

(WARNING: You must FULLY integrate all aspects of these instructions & this entire prompt into the final "autocrew.py" file!)
...
B. https://raw.githubusercontent.com/aibtcdev/ai-agent-crew/main/bitcoin_crew_app.py 
C. https://raw.githubusercontent.com/alejandro-ao/crewai-crash-course/master/src/main.py 
D. https://raw.githubusercontent.com/metamind-ai/autogen-agi/master/autogen_modified_group_chat.py 
E. https://github.com/Upsonic/Tiger https://raw.githubusercontent.com/MasterAI-Inc/libauto/v2.x/cui/pygame_impl/console_ui.py 
F. https://raw.githubusercontent.com/e-johnstonn/CrewAI/main/crewai/crew.py 
G. https://raw.githubusercontent.com/Malaeu/PraisonAI.-1/develop/praisonai/auto.py 
H. https://raw.githubusercontent.com/Malaeu/PraisonAI.-1/develop/praisonai/agents_generator.py 
I. https://raw.githubusercontent.com/Malaeu/PraisonAI.-1/develop/praisonai/deploy.py 

• Continue your research by exploring (A through D):

A. CrewAI LLM integrations CrewAI-Tools User made CrewAI tools Integrating CrewAI with Ollama Integrating CrewAI with external tools Autonomous CrewAI task & agent generation Advanced/Complex CrewAI example Python code (NOTE: You must continue your research beyond the URL's & topics provided to you above. 
B. It is critical that you review example projects, the correct variables/formats/functions/code for the Github programs that you're integrating such as "CrewAI", "CrewAI Tools", "Upsonic Tiger", and other programs/frameworks such as "Ollama". 
C. You are permitted to borrow, steal, utilize and review code & other existing projects online which use these systems & frameworks. 
D. Continuously & extensively research online until you are beyond 100% assured that you have acquired more than everything required to complete all aspects of all these instructions & criteria laid out within this prompt.
...
(NOTE: Your GUI must include but not be limited to all of the following GUI elements. You shall additionally incorporate additional GUI elements, functions, features, buttons, aesthetics, etc. which are not outlined by this prompt/section. EACH ELEMENT YOU ARE REQUIRED TO INCLUDE BELOW IS LABELED STARTING WITH "[GUI ELEMENT]".)

[GUI ELEMENT 1] : Objectives Text Box:
...
• Ensure that all additional ideas you integrate are solely focused on increasing the capabilities of Autocrew that will expand upon it's intelligence, abilities, functionality, and potential accomplishment - the goal is to have Autocrew capable of accomplishing literally ANY digital task, goal, request, etc. 
...
REQUIREMENT #2: YOUR CODE MAY NOT INCLUDE ANY PLACEHOLDERS, UNFINISHED CODE, OR CODE WHICH HAS NOT INTEGRATED EVERYTHING LAID OUT WITHIN THIS PROMPT NOR SHOULD YOU TRUNCATE ANY OF THE CODE!
...
REQUIREMENT #5: PERFORM ALL BRAINSTORMING, INTERNET RESEARCH, WORK, CODE GENERATION, REVISIONS IN ORDER TO PROVIDE ME ULTIMATELY WITH THE FULL, COMPLETE, NON-TRUNCATED "autocrew.py" FILE WITH 800x LINES OF CODE MINIMUM.

REQUIREMENT #6: DO NOT STOP RUNNING, WORKING, FUNCTIONING, AND GENERATING UNTIL EVERYTHING FROM THIS PROMPT HAS BEEN FULLY INTEGRATED INTO THE FULLY FINISHED PROGRAM!

REQUIREMENT #7: GENERATE & EXECUTE AN EXTENSIVE, DETAILED, IN-DEPTH SERIES OF TASKS WHICH YOU WILL EXECUTE - ALL THESE TASKS COMBINED ENSURE THAT EVERY SINGLE ASPECT, INSTRUCTION, REQUEST & CRITERIA LAID OUT WITHIN THIS PROMPT WILL BE FULLY INTEGRATED INTO THE PROGRAM "Autocrew", AND THAT ALL INSTRUCTIONS IN THIS PROMPT WILL BE FULLY ACCOMPLISHED & FOLLOWED!
...
```sh
git clone https://github.com/GPT-Engineer-App/retro-ai-crew.git
cd retro-ai-crew
npm i
